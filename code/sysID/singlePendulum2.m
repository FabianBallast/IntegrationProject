...
xlabel('Time (seconds)')
xlim([5 9])
saveas(f,'../../figures/sysID_sweepv4_theta1','epsc')
...
xlabel('Time (seconds)')
xlim([5 9])
saveas(f,'../../figures/sysID_sweepv4_theta2','epsc')
...
saveas(f,'../../figures/sysID_sweepv4_input','epsc')
...
saveas(f,'../../figures/sysID_sweepv4_polyfit','epsc')
...
saveas(f,'../../figures/sysID_sweepv4_polyfit_acc','epsc')
...
saveas(f,'../../figures/sysID_validation_link2','epsc')
%%
sys = pem(z, nlgr);
figure()
compare(z,nlgr,Inf)
